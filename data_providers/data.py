...
class Data(VideosDataset):
    def __init__(self, name, img_type, paths, normalization, sequence_length,
...
class DataProvider(DataProvider):
    def __init__(self, path, img_type, num_classes, validation_set=None, test=False,
        ...
        if self.img_type=='dynamic':
          self._path = self.path + 'hmdb51_dynamic/'
        elif self.img_type=='rgb':
          self._path = self._path + 'hmdb51_frames/'
        else:
          print("Must specify your")
